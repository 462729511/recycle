// recycle/pages/recycl/recycl.js
...
Page({
  ...
  recyclName:function(e){
    this.setData({
      recyclName: e.detail.value
    })
  },
  formSubmit:function(e){
    ...
    if (!phoneReg.test(phone)) {
      ...
      warn = '请输入地址'
    } else if (e.detail.value.recyclName == "") {
      warn = '请输入废品名称'
    ...
    var title = e.detail.value.recyclName
    ...
    wx.uploadFile({
      ...
      complete: () => {
        ...
        if (i == data.path.length) {   //当图片传完时，停止调用          
          ...
          http.post('post_recycler', data.data).then(data => {
            console.log(data);
            wx.redirectTo({
              url: '../index/index',
            }) 
